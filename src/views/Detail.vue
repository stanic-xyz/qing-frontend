          ...
          <div class="baseblock2">
            ...
            <ul class="blockcontent">
              ...
              <li class="detail_imform_kv">
                ...
                <span class="detail_imform_value">{{
                  dateFormat(animeInfo.premiereDate)
                }}</span>
              </li>
              <li class="detail_imform_kv">
              ...
              <li class="detail_imform_kv">
                ...
                <span class="detail_imform_value">
                  <a :href="animeInfo.officialWebsite" target="_blank">{{
        ...
        <div class="blockcontent">
          ...
          <div style="padding-left: 8px">
            <button
              id="btnrecommend"
              class="switchbtn"
              onclick="onbtnrecommend(this)"
            >
              相关推荐
            </button>
            <button
              id="btncomment"
              class="switchbtn switchbtn_current"
              onclick="onbtncomment(this)"
            >
              留言板
            </button>
          </div>
              ...
              <li class="anime_icon1">
                <a href="/detail/20160111">
                  <img
                    ...
                    data-src="https://sc02.alicdn.com/kf/H3e0ebe3098c345e9af4d0a68fc601667H.jpg"
                    height="205"
                    referrerpolicy="no-referrer"
            ...
            <ul class="comment_page">
              <li>
                <a
                  ...
                  onclick="${data.comments.current==1}"
                  >首页</a
                >
              </li>
